Feature: A User should create a Focal Link custom block
  ...
  @api
  Scenario: Add a Focal link with a default icon
    ...
    When I fill in "Title" with "Block Focal Link"
      And I select "Phone" from "Icon Selection"
    ...
    Then I should see the link "Focal Link" in the "Sidebar First Region"
      And I should see the ".focal-link__icon--contact" element in the "Sidebar First Region"
